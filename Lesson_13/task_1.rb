...
class PassengerTrain
  ...
  attr_reader :next_station, :last_station, :carriages
  ...
  def add_carriage(carriage)
    carriages << carriage if carriage.class == PassengerCarriage
  end
end
...
class CargoTrain
  ...
  def add_carriage(carriage)
    carriages << carriage if carriage.class == CargoCarriage
  end
end
